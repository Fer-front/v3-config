...
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/tecnologia.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/cinema.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/mov.uol.com.br.gitp
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/tilt.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/comidasebebidas.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/nossa.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/tvefamosos.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/noticias.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/tvuol.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/universa.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/urbantaste.uol.com.br.git
...
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/entretenimento.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/archived-www.bol.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/esporte.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/resumo.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/www.uol.git
...
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/www.uol.com.br.git
git clone https://${userName}:${NEW_PWD}@stash.uol.intranet/scm/dcweb/jogos.uol.com.br.git
